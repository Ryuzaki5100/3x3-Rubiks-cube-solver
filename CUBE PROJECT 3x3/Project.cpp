...
map<char, map<int, int>> nextOrientation = {{'R', {{3, 2}, {2, -3}, {-3, -2}, {-2, 3}}}, {'U', {{2, 1}, {1, -2}, {-2, -1}, {-1, 2}}}, {'F', {{3, 1}, {1, -3}, {-3, -1}, {-1, 3}}}, {'B', {{1, 3}, {3, -1}, {-1, -3}, {-3, 1}}}, {'D', {{1, 2}, {2, -1}, {-1, -2}, {-2, 1}}}, {'L', {{2, 3}, {3, -2}, {-2, -3}, {-3, 2}}}, {'f', {{{3, 1}, {1, -3}, {-3, -1}, {-1, 3}}}}, {'u', {{2, 1}, {1, -2}, {-2, -1}, {-1, 2}}}};
map<char, map<int, int>> nextEdgePosition = {{'R', {{2, 5}, {5, 10}, {10, 6}, {6, 2}}}, {'U', {{0, 1}, {1, 2}, {2, 3}, {3, 0}}}, {'F', {{3, 6}, {6, 11}, {11, 7}, {7, 3}}}, {'B', {{1, 4}, {4, 9}, {9, 5}, {5, 1}}}, {'D', {{8, 11}, {11, 10}, {10, 9}, {9, 8}}}, {'L', {{0, 7}, {7, 8}, {8, 4}, {4, 0}}}, {'f', {{3, 6}, {6, 11}, {11, 7}, {7, 3}, {0, 2}, {2, 10}, {10, 8}, {8, 0}}}, {'u', {{0, 1}, {1, 2}, {2, 3}, {3, 0}, {4, 5}, {5, 6}, {6, 7}, {7, 4}}}};
map<char, map<int, int>> nextCornerPosition = {{'R', {{1, 5}, {5, 6}, {6, 2}, {2, 1}}}, {'U', {{0, 1}, {1, 2}, {2, 3}, {3, 0}}}, {'F', {{2, 6}, {6, 7}, {7, 3}, {3, 2}}}, {'B', {{0, 4}, {4, 5}, {5, 1}, {1, 0}}}, {'D', {{4, 7}, {7, 6}, {6, 5}, {5, 4}}}, {'L', {{0, 3}, {3, 7}, {7, 4}, {4, 0}}}, {'f', {{2, 6}, {6, 7}, {7, 3}, {3, 2}}}, {'u', {{0, 1}, {1, 2}, {2, 3}, {3, 0}}}};
map<int, string> crossPiecePositioning = {{0, "UU"}, {1, "U"}, {2, ""}, {3, "UUU"}, {4, "LULLL"}, {5, "RRRUR"}, {6, "RURRR"}, {7, "LLLUL"}, {8, "LLU"}, {9, "BBU"}, {10, "RRU"}, {11, "FFU"}};
map<int, string> crossPieceInsertion = {{1, "RRRFRFFF"}, {3, "UFF"}};
...
map<int, map<int, string>> secondLayerAlgo[8] = {{{3, {{4, "LLLUUULLLUUULLLULUL"}, {5, "UURURURUUURRRUUURRR"}, {6, "UURRRUUURRRUUURRRURUR"}, {7, "LULULUUULLLUUULLL"}}}, {-1, {{4, "UULUUULLLUUUfffLf"}, {5, "RRRURUfRRRfff"}, {6, "RUUURRRFRRRFFFR"}, {7, "UULLLULFFFLFLLL"}}}},
                                                 {{3, {{4, "UUULLLUUULLLUUULLLULUL"}, {5, "URURURUUURRRUUURRR"}, {6, "URRRUUURRRUUURRRURUR"}, {7, "UUULULULUUULLLUUULLL"}}}, {-1, {{4, "ULUUULLLUUUfffLf"}, {5, "UUURRRURUfRRRfff"}, {6, "UUURUUURRRFRRRFFFR"}, {7, "ULLLULFFFLFLLL"}}}},
                                                 {{3, {{4, "UULLLUUULLLUUULLLULUL"}, {5, "RURURUUURRRUUURRR"}, {6, "RRRUUURRRUUURRRURUR"}, {7, "UULULULUUULLLUUULLL"}}}, {-1, {{4, "LUUULLLUUUfffLf"}, {5, "UURRRURUfRRRfff"}, {6, "UURUUURRRFRRRFFFR"}, {7, "LLLULFFFLFLLL"}}}},
                                                 {{3, {{4, "ULLLUUULLLUUULLLULUL"}, {5, "UUURURURUUURRRUUURRR"}, {6, "UUURRRUUURRRUUURRRURUR"}, {7, "ULULULUUULLLUUULLL"}}}, {-1, {{4, "UUULUUULLLUUUfffLf"}, {5, "URRRURUfRRRfff"}, {6, "URUUURRRFRRRFFFR"}, {7, "UUULLLULFFFLFLLL"}}}},
                                                 {{2, {{4, ""}, {5, "BBUUBBUUBB"}, {6, "uuRURRRuuUUURUURRR"}, {7, "LLUULLUULL"}}}, {-1, {{4, "fffLfUUULUULLLUULUUULLL"}, {5, "uRRRUUURuuuRRRUUR"}, {6, "BBBURRRUUURRRUUURRRURURB"}, {7, "uuuLLLUULuLLLULLL"}}}},
                                                 {{2, {{4, "BBUUBBUUBB"}, {5, ""}, {6, "RRUURRUURR"}, {7, "uuLLLUUULuuULLLUUL"}}}, {1, {{4, "uuuLULLLuLUULLL"}, {5, "fRRRfffURRRUURURRRUUR"}, {6, "uRUURRRuuuRUUURRR"}, {7, "BUUULULULUUULLLUUULLLBBB"}}}},
                                                 {{-2, {{4, "uuLULLLUUUuuLUULLL"}, {5, "RRUURRUURR"}, {6, ""}, {7, "FFUUFFUUFF"}}}}};
class Cube
{
public:
...
int main()
{
    ...
    getline(cin, alg);
    alg = translate(alg);
    c.performAlgorithm(alg);
    c.printCubeStats();
    // cout<<alg.length();
    // cout<<endl<<alg;
    // c.performAlgorithm(alg);
    // // printAlgorithm(convert(alg));
    // vector<string> a = convert(c.performCross()), b = convert(c.performFirstLayer());
    // cout << "Cross solution -- ";
    // printAlgorithm(a);
    // // cout<<"First Layer solution -- ";
    // // printAlgorithm(b);
    // // cout<<c.performCross();
    // // cout<<endl<<c.performFirstLayer()<<endl;
    // // cout << "Total number of moves to solve upto first layer -- " << a.size() + b.size() << endl
    // //  << endl;
    // c.printCubeStats();
}